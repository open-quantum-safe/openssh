...
///// OQS_TEMPLATE_FRAGMENT_HANDLE_ID_FILES_START
		  ...
		  case KEY_DILITHIUM_3_AES:
		    name = _PATH_SSH_CLIENT_ID_DILITHIUM_3_AES;
		    break;
		  ...
		  case KEY_ECDSA_NISTP256_DILITHIUM_2_AES:
		    ...
		    break;
		  case KEY_ECDSA_NISTP384_DILITHIUM_3_AES:
		    name = _PATH_SSH_CLIENT_ID_ECDSA_NISTP384_DILITHIUM_3_AES;
		    break;
		  case KEY_ECDSA_NISTP521_DILITHIUM_5_AES:
...
///// OQS_TEMPLATE_FRAGMENT_DEFINE_KEY_TYPES_START
		...
		{ "dilithium3aes", "DILITHIUM_3_AES", _PATH_HOST_DILITHIUM_3_AES_KEY_FILE },
		...
		{ "ecdsa_nistp384_dilithium3aes", "ECDSA_NISTP384_DILITHIUM_3_AES", _PATH_HOST_ECDSA_NISTP384_DILITHIUM_3_AES_KEY_FILE },
...
do_change_comment(struct passwd *pw, const char *identity_comment)
{
	...
	if (private->type != KEY_ED25519 &&
	    ...
	    private->type != KEY_DILITHIUM_3_AES &&
	    ...
	    private->type != KEY_ECDSA_NISTP384_DILITHIUM_3_AES &&
...
///// OQS_TEMPLATE_FRAGMENT_PRINT_RESOURCE_RECORDS_START
			...
			n += do_print_resource_record(pw,
			    ...
			    print_generic);
			n += do_print_resource_record(pw,
			    _PATH_HOST_DILITHIUM_3_AES_KEY_FILE, rr_hostname,
			    print_generic);
			n += do_print_resource_record(pw,
			    _PATH_HOST_ECDSA_NISTP384_DILITHIUM_3_AES_KEY_FILE, rr_hostname,
			    print_generic);
			n += do_print_resource_record(pw,
